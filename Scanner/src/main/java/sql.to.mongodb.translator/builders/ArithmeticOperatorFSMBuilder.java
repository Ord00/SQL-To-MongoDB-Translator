...
import sql.to.mongodb.translator.finite.automata.FSMState;
import sql.to.mongodb.translator.finite.automata.FSMTransition;

import java.util.ArrayList;
import java.util.List;

public class ArithmeticOperatorFSMBuilder extends FSMBuilder {
    @Override
    public FSM build() {
