                                                        ...
                                                        $and: [
                                                            {
                                                                $and: [
                                                                    {
                                                                        $and: [
                                                                            { $gte: ["$RaceDate", "$TS3.EntryDate"] },
                                                                            {
                                                                                $or: [
                                                                                    { $eq: ["$TS3.ExitDate", null] },
                                                                                    { $lte: ["$RaceDate", "$TS3.ExitDate"] }
                                                                                ]
                                                                            }
                                                                        ]
                                                                    },
                                                                    { $eq: ["$$outer_id_team", "$Tm3.Id_team"] }
                                                                ]
                                                            },
                                                            { $eq: ["$$id_competition", "$Competition"] }
                                                        ]
                                                    }
                                                }
                                            }
